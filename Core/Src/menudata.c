...
static uint8_t CENTER_DATA[]= {CENTER_ALIGN,0, 2, 3 };
...
static xScreenObjet const SettingMenuScreen[]=
{
  ...
  { 0U, 5U		   , LINE2, 1U, DATA,  0U, (void*)vGetDataForMenu,MB_ADRESS_ID, RIGTH_DATA   },
  { 0U, 7U		   , LINE2, 11U, TEXT_STRING,  "Упр.", 0U, 0U, NULL  },
  { LAST_OBJECT, 19U, LINE2, 1U, DATA,  0U, (void*)vGetDataForMenu, CONTROL_TYPE_ID, RIGTH_DATA    },
};
...
static xScreenObjet const LampErrorScreen[]  =
{
   ...
   { LAST_OBJECT, 6U, 		 LINE2, 2U,  DATA,  0U,(void*)vGetErrorForMenu, SCREEN_INDEX_ID, RIGTH_DATA },
   { 0U, 17U, LINE1, 0U, TEXT_STRING,  "/", 0U, 0U , NULL },
   { 0U, 18U, LINE1, 2, DATA,  0U, (void*)vGetLapmErrorForMenu,   TOTAL_ERROR_ID, LEFT_DATA  },
   { LAST_OBJECT, 1U, LINE2, 7U,  DATA,  0U,(void*)vGetLapmErrorForMenu, ERROR_DATA_ID, CENTER_DATA },
};
...
static xScreenObjet const LampSetRecourceScreen[] =
{
	...
	{ 0U, 17U, LINE1, 0U, TEXT_STRING,  "/", 0U, 0U , NULL },
	{ 0U, 18U, LINE1, 2, DATA,  0U, (void*)vGetRecourceForMenu,  TOTAL_LAMP_DATA_ID, LEFT_DATA  },
	{ LAST_OBJECT, 10U, LINE2, 2U,  EDIT_DATA,  0U,(void*)vGetRecourceForMenu, LAMP_RES_PROCENT_DATA_ID , CENTER_DATA },
};
...
{
   { 0U, LEFT_OFFSET, LINE1, 5U, TEXT_STRING,  "Назначить ресурс всем", 0U, 0U , NULL },
   { LAST_OBJECT, 10, LINE2, 2U, EDIT_DATA,  NULL, (void*)vGetRecourceForMenu, ALL_LAMP_RES , CENTER_DATA  },
};
...
static xScreenObjet const TimeSetScreen[] =
{
   ...
   { LAST_OBJECT, 10, LINE2, 2U, MULTI_EDIT_DATA,  NULL, (void*)vSetTimeForMenu, NULL , NULL },
};

static xScreenObjet const DateSetScreen[] =
{
   { 0U, LEFT_OFFSET, LINE1, 5U, TEXT_STRING,  "Установить дату", 0U, 0U , NULL },
   { LAST_OBJECT, 10, LINE2, 2U, MULTI_EDIT_DATA,  NULL, (void*)vSetDateForMenu, NULL , NULL },
};

static xScreenObjet const ControlTypeScreen[]=
{
	{ 0U, LEFT_OFFSET, LINE2, 5U, TEXT_STRING,  "Tип управления", 0U, 0U , NULL },
	{ LAST_OBJECT, 16, LINE4, 5U,  EDIT_DATA,  NULL , (void*)vGetDataForMenu, CONTROL_TYPE, CENTER_DATA },
};

static xScreenObjet const MBScreen[] =
{
   { 0U, LEFT_OFFSET, LINE1, 5U, TEXT_STRING,  "Адрес MODBUS", 0U, 0U , NULL },
   { LAST_OBJECT, 10, LINE2, 2U, EDIT_DATA,  NULL, (void*)vGetDataForMenu, MOD_BUS_ADDRES , CENTER_DATA  },
};
...
static xScreenObjet const FBOWSizeScreen[]=
{
  ...
  { LAST_OBJECT, 15U, LINE2, 5U,  EDIT_DATA,    0U,(void*)vGetFBOWSizeForMenu, 0, CENTER_DATA4  },
};

static xScreenObjet const FBOLSizeScreen[]=
{
  { 0U, LEFT_OFFSET, LINE1, 14U, TEXT_STRING,  "Типоразмер ФБО XXX", 0U, 0U , NULL },
  { LAST_OBJECT, 15U, LINE2, 5U,  EDIT_DATA,    0U,(void*)vGetFBOLSizeForMenu, 0, CENTER_DATA3  },
};
...
xScreenType  xDevoloperMenuScreens[DEVOLOPER_MENU_COUNT ]=
{
  ...
  {FBOHSizeScreen,    &xMainMenu, NULL    ,0,0,0, MULTI_PARAMETR_EDIT  },
  {FBOLSizeScreen,     &xMainMenu, NULL    ,0,0,0, ONE_PARAMETR_EDIT   },
